...
export class OtherProjects extends Component {
    constructor() {
        ...
        super()
        this.state = {
            open: false, open2: false, open3: false, open4: false,openHaus:false,openReno:false,openPM:false, category: "code", projectList: "", codeList: [
                {
            ...
            <div className="container" >
                ...
                <div className="row">
                    ...
                    onClick={()=>this.changeCategory("")} icon
                        ...
                        </Button><Button style={{ float: 'left', transitionDuration: '0.5s',color:this.state.designActive ? "#fff":undefined,backgroundColor:this.state.designActive ? "#000":undefined }}
