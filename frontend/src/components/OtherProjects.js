...
export class OtherProjects extends Component {
    ...
    justifyContent: 'center',
                    ...
                    <Project color="#e0822b" year="2019" onClick={this.open} title="Landlord-Tenant App" icon1={java} icon2={python} desc="C++ application to help tenants effectively communicate with their Landlords through messaging, maintenance requests, and rent payments." />
                    <Project color="#813cc7"year="2019" onClick={this.open} title="Course Projects" icon1={java} icon2={python} desc="Various algorithm program implementations in Java with brute force and optimized approaches and comparisons. Simulated banking system in Python to practice common QA techniques." />
                    ...
                    <Project color="#FFB615"year="2018" onClick={this.openSoon} title="Enbridge Project Mgmt. Tool" icon1={js} icon2={ps} icon3="" desc="Internal Enbridge Application - Engineering Dept. Project Management Tool to allow PMs to submit status updates and display them on a compiled dashboard." />
