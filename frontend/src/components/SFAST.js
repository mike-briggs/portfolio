        ...
        <div className="header-text">
            <div style={{ padding: '0px' }} className="row" >
              ...
              <div className="col-lg-7 col-md-7 col-sm-12 spacing2">
                ...
                <h4 style={{ paddingBottom:'30px',fontFamily: 'Raleway', lineHeight:'20pt', fontSize:'14px',fontWeight:'400', letterSpacing:'0.1pt' }} className="">Internal Enbridge Application - Station Field Assesment Survey Tool. An application to collect information about field asset integrity and report findings to management.</h4>
                  <div className="row">
            ...
            <div style={{ padding: '0px' }} className="row" >
              <div className="col-lg-2 col-md-3"></div>
               <div className="col-lg-10 col-md-10 col-sm-12 spacing2">
                ...
                <div className="col-lg-10 col-md-10 col-sm-12 col-12">
                <h4 style={{ paddingBottom:'30px',fontFamily: 'Raleway', lineHeight:'20pt', fontSize:'14px',fontWeight:'400', letterSpacing:'0.1pt' }} className="">The application retrieves important details starting from mobile use in the field to desktop inspections.</h4>
